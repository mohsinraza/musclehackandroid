...
public class SimpleProgramAdapter extends SimpleCustomableAdapter {
	public SimpleProgramAdapter(Context context, List<? extends Map<String, ?>> data,
	...
	protected void bindView(int position, View view) {
		...
		String program = textView.getText().toString();

		Log.d("SimpleExerciseAdapter", "boolean done = WorkoutManagerSingleton.getInstance().isWeekCompleted(day);...");
		boolean done = WorkoutManagerSingleton.getInstance().isProgramCompleted(program);
