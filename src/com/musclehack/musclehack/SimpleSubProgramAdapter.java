...
public class SimpleSubProgramAdapter extends SimpleCustomableAdapter {
	public SimpleSubProgramAdapter(Context context, List<? extends Map<String, ?>> data,
	...
	protected void bindView(int position, View view) {
		...
		boolean done = WorkoutManagerSingleton.getInstance().isSubProgramCompleted(day);
